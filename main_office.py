...
from utils3 import TwoCropTransform,random_update,set_loader,set_weighted_loader,buffer_loader,MyDataset,Pad,Convert2RGB
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='rmnist',
                        choices=['mix_office','rmnist','cifar10', 'cifar100', 'tiny-imagenet','mix_digit'], help='dataset')
...
def main():
    ...
    if wandb_ifuse:
        wandb.init(project=opt.dataset, entity="result")
    ...
    if opt.dataset == 'cifar10':
        ...
        from dataloaders import office as dataloader
    elif opt.dataset == 'rmnist':
    ...
    if wandb_ifuse:
        ...
        wandb.log({"Buffersize": opt.Buffersize})
        wandb.finish()
